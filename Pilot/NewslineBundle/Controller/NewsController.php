...
use Pilot\NewslineBundle\Entity\News;
use Pilot\NewslineBundle\Form\NewsType;
...
class NewsController extends Controller {
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('PilotNewslineBundle:News')->findAll();
     ...
     * @Method("POST")
     * @Template("PilotNewslineBundle:News:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('PilotNewslineBundle:News')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PilotNewslineBundle:News:edit.html.twig")
     */
    public function updateAction(Request $request, $id) {
        ...
        if ($editForm->isValid()) {
            $records = $em->getRepository('PilotNewslineBundle:NewsAuthor')->findByNews($id);
