...
namespace Pilot\NewslineBundle\Controller;
...
use Pilot\NewslineBundle\Entity\Author;
use Pilot\NewslineBundle\Form\AuthorType;
...
class AuthorController extends Controller {
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('PilotNewslineBundle:Author')->findAll();
     ...
     * @Method("POST")
     * @Template("PilotNewslineBundle:Author:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('PilotNewslineBundle:Author')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PilotNewslineBundle:Author:edit.html.twig")
     */
    public function updateAction(Request $request, $id) {
        ...
        if ($editForm->isValid()) {
            $records = $em->getRepository('PilotNewslineBundle:NewsAuthor')->findByAuthor($id);
